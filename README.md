...
| `系统变更说明文档/` | **每个版本的变更说明 + 下版计划**（每完成一个版本必更新） |
| `系统变更说明文档/README.md` | 该目录说明与版本索引 |
| `系统变更说明文档/_模板.md` | 版本变更说明的模板，新建版本复制改名 |
| `系统变更说明文档/v0.01.md` | v0.01 版本的变更说明 |
| `当前系统文档/系统架构.md` | **当前系统真实架构快照**（每次架构/接口变更必更新） |
...
- **要了解"现在系统长什么样"** → 看 `当前系统文档/系统架构.md`
- **要了解"每个版本改了啥、下一步做啥"** → 看 `系统变更说明文档/`

> 规则：每完成一个版本（从 v0.01 起依次累计、不跨版本），**必须同步更新「系统变更说明文档」与「当前系统文档」**。
