...
> 最近更新：2026-06-06　|　对应版本：**v0.11**（目录 + 用户端数据门户 + 下载，dev 分支）
...
| 后端代码 | 🟡 安全/认证/数据源/数据集/SQL→Excel + **目录 + 用户端门户(可见性过滤/下载)**（v0.11，60 测试） |
| 前端代码 | 🟡 管理端(数据源/数据集/目录) + **用户端门户(浏览/详情/下载)**（v0.11，build/lint 通过） |
